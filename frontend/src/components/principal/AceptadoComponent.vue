  ...
  <v-row justify="center" align="center">
    ...
    <v-col cols="12" md="12">
      <v-data-table
        ...
        class="elevation-1"
        :search="search"
        :no-data-text="'No hay facturaciones aceptadas por el cliente'"
        :no-results-text="'El registro que usted busca no se encuentra'"
      >
        <template v-slot:top>
          <v-toolbar flat>
            <v-toolbar-title>Entregas aceptadas por el cliente</v-toolbar-title>
            <v-spacer></v-spacer>
            <v-text-field
              v-model="search"
              clearable
  ...
  data() {
    return {
      ...
      dessertHeaders: [
        ...
        { text: "Entregado", value: "delivery_time" },
